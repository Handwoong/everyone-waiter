...
public enum ErrorCode {
    ...
    MEMBER_EXISTS(BAD_REQUEST, "이미 존재하는 회원입니다."),

    PHONE_NUMBER_EXISTS(BAD_REQUEST, "이미 존재하는 휴대폰 번호입니다."),

    MEMBER_OR_PHONE_EXISTS(BAD_REQUEST, "이미 존재하는 회원이거나 휴대폰 번호입니다."),

    TELEPHONE_NUMBER_EXISTS(BAD_REQUEST, "이미 존재하는 전화번호입니다."),

    STORE_EXISTS(BAD_REQUEST, "이미 존재하는 매장입니다."),
